    ...
    public Object getCellValue(Row row, int column) {
        ...
        try {
            ...
            if (cell != null) {
                ...
                } else if (cell.getCellType() == CELL_TYPE_BOOLEAN) {
                    val = cell.getBooleanCellValue();
                } else if (cell.getCellType() == CELL_TYPE_ERROR) {
        ...
        for (int i = this.getDataRowNum(); i <= this.getLastDataRowNum(); i++) {
            ...
            for (Object[] os : annotationList) {
                ...
                if (val != null) {
                    ...
                    // If is sysdict type, get sysdict value
					/*
					...
					*/
                    ...
                    try {
                        if (valType == Boolean.class) {
                            ...
                            val = DateUtils.stringToDate(val.toString(),DateUtils.DATE_TIME_FORMAT);
                        } else if (valType == List.class) {
                            String strValue = val.toString();
                            if (strValue.startsWith("[") && strValue.endsWith("]")) {
                                val = JSONArray.parseArray(strValue, String.class);
                            } else {
                                String[] strArray = strValue.split(",");
                                val = Arrays.asList(strArray);
                            }
